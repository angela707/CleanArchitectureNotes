...
import com.training.cleanarchitecture.business.domain.state.StateEvent
import com.training.cleanarchitecture.business.domain.state.StateMessage
...
sealed class NoteDetailStateEvent : StateEvent {
    ...
    class DeleteNoteEvent(val note: Note) : NoteDetailStateEvent() {
        override fun errorInfo(): String {
    ...
    class CreateStateMessageEvent(val stateMessage: StateMessage) : NoteDetailStateEvent() {
        override fun errorInfo(): String {
